%============================================================ %
% This function generates multiclass support vector machine   %
% (SVM) models in classifying                                 %
...
function [k, mean_k, label_cell, y1_cell,kFoldLoss,SVMModels,crossval_SVM]=data_traintest3_multiclass_17classes_SVM(data_traintest1,data_traintest2,...
 ...
 % Example: [k, mean_k, label, y1,kFoldLoss,SVMModels,crossval_SVM]=data_traintest3_multiclass_17classes_SVM(As_3600, ...
...
cl2= fitcecoc(DATA_Train,y,'Learners',t,'FitPosterior',true');toc; %training
