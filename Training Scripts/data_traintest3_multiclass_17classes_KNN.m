%============================================================ %
%This function generates multiclass k-nearest neighbors (KNN) % 
...
function [k, mean_k, label_cell, y1_cell,kFoldLoss,KNNModels,crossval_KNN]=data_traintest3_multiclass_17classes_KNN(data_traintest1,data_traintest2,...
...
tStart=tic;
 % Example: [k, mean_k, label, y1,kFoldLoss,KNNModels,crossval_KNN]=data_traintest3_multiclass_17classes_KNN(As_3600, ...
...
t = templateKNN('Standardize',1,'NumNeighbors',3);
cl2= fitcecoc(DATA_Train,y,'Learners',t); toc; %training
