%============================================================ %
%This function generates multiclass Feed Forward Neural       %
% Network (FFNN) models in classifying 17 Baybayin characters %                                       %  
%------------------------------------------------------------ %
...
function [k, mean_k, label_cell, y1_cell,kFoldLoss, FFNN_Models]=data_traintest3_multiclass_17classes_FFNN(data_traintest1,data_traintest2,...
...
tStart=tic;
 % Example: [k, mean_k, label, y1,kFoldLoss,FFNN_Models]=data_traintest3_multiclass_17classes_FFNN(As_3600, ...
...
cl2= fitcnet(DATA_Train,y,'LayerSizes',[409 213]); toc; %training
