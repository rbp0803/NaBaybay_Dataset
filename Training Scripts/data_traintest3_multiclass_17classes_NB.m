%============================================================ %
%This function generates multiclass Naive Bayes (NB) models   % 
% in classifying 17 Baybayin characters.                      %  
%------------------------------------------------------------ %
...
function [k, mean_k, label_cell, y1_cell,kFoldLoss,NBModels,crossval_NB]=data_traintest3_multiclass_17classes_NB(data_traintest1,data_traintest2,...
...
tStart=tic;
 % Example: [k, mean_k, label, y1,kFoldLoss,NBModels,crossval_NB]=data_traintest3_multiclass_17classes_NB(As_3600, ...
...
t = templateNaiveBayes('DistributionNames','mn');
