%============================================================ %
%This function generates multiclass Adaptive Boosting (AB)    %
% models in classifying 17 Baybayin characters.               %
%------------------------------------------------------------ %
...
function [k, mean_k, label_cell, y1_cell,kFoldLoss,ABModels,crossval_AB]=data_traintest3_multiclass_17classes_AB(data_traintest1,data_traintest2,...
...
tStart=tic;
 % Example: [k, mean_k, label, y1,kFoldLoss,ABModels,crossval_AB]=data_traintest3_multiclass_17classes_AB(As_3600, ...
%Bas_3600, Kas_3600, Das_3600, EIs_3600, Gas_3600, Has_3600, Las_3600, Mas_3600, Nas_3600, Ngas_3600, OUs_3600,...
%Pas_3600, Sas_3600, Tas_3600, Was_3600, Yas_3600, 0.20, 1);       
...
t = templateTree('Surrogate','on','MaxNumSplits',800); 
cl2= fitcensemble(DATA_Train,y,'Method','AdaBoostM2','Learners',t); toc; %training
...
[label]=predict(Trained_cl,Xtest);
label_cell{j}=label;
